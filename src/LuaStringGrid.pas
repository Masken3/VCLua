...
Uses Classes, Types, Controls, Contnrs, LuaPas, LuaControl, Forms, Grids, StdCtrls, TypInfo;
...
function GetColParam(L: Plua_State): Integer; cdecl;
var
  lStringGrid:TLuaStringGrid;
  LGridCol: TGridColumn;
  prop :String;
begin
  ...
  // clear stack
  lua_remove(L,2);
  lua_pushtable_object(L, LGridCol, 1);
  // lua_pushstring(L,pchar(prop));
  LuaGetProperty(L);
  Result := 1;
end;
...
begin
  ...
  LuaSetTableFunction(L, Index, 'GetColParam', @GetColParam);
